...
public class Address 
{
	...
	public static void main(String[] args) 
	{
		...
		Address b=new Address("209","phan thanh","thanh khe","da nang");
		b.output();
		
		String number="30";
		String street="tran phu";
		String district="hai chau";
		String city="da nang";
		//phai co du lieu truoc
		Address c=new Address(number,street,district,city);
		c.output();
